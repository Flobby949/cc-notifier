...
export type NotificationHookType = 'permission_prompt' | 'idle_prompt' | 'auth_success' | 'elicitation_dialog';
...
export interface NotificationConfig {
  ...
  enableNotificationHook: boolean;  // 是否启用 Notification hook（权限请求等通知）
  notificationHookTypes: NotificationHookType[]; // 需要通知的事件类型
